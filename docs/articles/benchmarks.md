...
<!-- Updated: 2026-03-29 | Commit: fdfc412 | Branch: master -->
...
regression tracking, see [Performance Tracking (Issue #105)](https://github.com/Dtronix/Quarry/issues/105#issuecomment-4149509098).
...
|---|---:|---:|---:|---:|---:|
| **Aggregates** | | | | | |
| Count | 3.23 | 1.03x | <u>1.02x</u> | 2.50x | 3.42x |
| Sum | 9.37 | 1.01x | <u>1.01x</u> | 1.61x | 8.97x |
| Avg | 9.58 | 0.98x | <u>0.96x</u> | 1.53x | 8.50x |
| **Cold Start** | | | | | |
| ColdStart | 99.07 | 1.22x | <u>1.00x</u> | 1.15x | 2.14x |
| **Complex Queries** | | | | | |
| JoinFilterPaginate | 15.79 | 0.84x | <u>1.01x</u> | 2.61x | 3.96x |
| MultiJoinAggregate | 33.33 | 1.02x | <u>1.01x</u> | 1.48x | 2.17x |
| **Conditional** | | | | | |
| ConditionalQuery | 47.48 | 1.13x | <u>0.99x</u> | 1.45x | 1.86x |
| **Delete** | | | | | |
| DeleteSingleRow | 26.73 | 1.21x | <u>1.03x</u> | 2.20x | 15.06x |
| **Filters** | | | | | |
| WhereById | 6.46 | 1.29x | <u>0.97x</u> | 2.46x | 3.35x |
| WhereCompound | 41.19 | 1.30x | <u>0.99x</u> | 1.21x | 1.84x |
| WhereActive | 97.25 | 1.28x | <u>1.04x</u> | 1.13x | 1.39x |
| **Inserts** | | | | | |
| SingleInsert | 28.50 | 1.30x | <u>1.10x</u> | 2.04x | 21.10x |
| BatchInsert10 | 84.20 | 1.85x | <u>0.97x</u> | 1.71x | 19.15x |
| **Joins** | | | | | |
| InnerJoin | 82.93 | 0.72x | <u>1.01x</u> | 1.14x | 1.51x |
| ThreeTableJoin | 243.00 | 0.78x | <u>0.98x</u> | 1.06x | 1.28x |
| **Pagination** | | | | | |
| LimitOffset | 16.09 | 1.33x | <u>1.07x</u> | 2.04x | 2.47x |
| FirstPage | 15.77 | 1.26x | <u>1.04x</u> | 2.00x | 2.35x |
| **Select** | | | | | |
| SelectProjection | 45.04 | 1.35x | <u>0.97x</u> | 1.13x | 1.60x |
| SelectAll | 107.85 | 1.23x | <u>1.01x</u> | 1.05x | 1.29x |
| **String Ops** | | | | | |
| Contains | 17.40 | 1.12x | <u>1.04x</u> | 2.97x | 2.35x |
| StartsWith | 53.00 | 1.31x | <u>0.99x</u> | 1.69x | 1.70x |
| **Throughput** | | | | | |
| Throughput (ms) | 6,457 | 1.34x | <u>0.93x</u> | 2.52x | 3.76x |
| **Update** | | | | | |
| UpdateSingleRow | 24.14 | 1.26x | <u>1.06x</u> | 2.73x | 18.38x |
...
| **Complex Queries** | | | | |
| JoinFilterPaginate | 1.13x | <u>1.08x</u> | 11.97x | 7.89x |
| MultiJoinAggregate | 1.07x | <u>1.11x</u> | 27.09x | 15.77x |
| **Conditional** | | | | |
| ConditionalQuery | 1.33x | <u>1.06x</u> | 3.50x | 2.90x |
| **Delete** | | | | |
| DeleteSingleRow | 1.41x | <u>1.05x</u> | 10.79x | 79.29x |
| **Filters** | | | | |
| WhereById | 1.78x | <u>0.93x</u> | 13.26x | 5.23x |
...
| **Pagination** | | | | |
| LimitOffset | 1.45x | <u>1.16x</u> | 6.45x | 3.92x |
| FirstPage | 1.45x | <u>1.16x</u> | 6.02x | 3.40x |
| **Select** | | | | |
| SelectProjection | 1.51x | <u>1.01x</u> | 2.12x | 3.56x |
| SelectAll | 1.32x | <u>1.17x</u> | 1.52x | 2.07x |
| **String Ops** | | | | |
| Contains | 1.48x | <u>1.08x</u> | 9.49x | 7.31x |
| StartsWith | 1.51x | <u>1.02x</u> | 2.62x | 3.88x |
| **Throughput** | | | | |
| Throughput | 1.88x | <u>1.15x</u> | 14.05x | 6.34x |
| **Update** | | | | |
...
**Best results:** Quarry is *faster* than hand-written ADO.NET on avg (0.96x), where-by-id
(0.97x), select-projection (0.97x), batch-insert (0.97x), three-table-join (0.98x), throughput
(0.93x), and conditional queries (0.99x). It also allocates *less* memory than Raw on update
(0.89x) and where-by-id (0.93x).

**Highest overhead:** Single-insert (1.10x), limit-offset (1.07x), and update (1.06x) show the
