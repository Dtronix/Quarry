...
- 8 / 12 plan phases complete.
- Track A (analyzer / generator hardening): **complete**.
- Track B (test conversion): 5 / 9 phases done.

## Current State

- Branch: `cross-dialect-test-coverage`, 8 commits ahead of `master`.
- Working tree: clean.
- Tests: 3353 / 3353 passing (Quarry.Analyzers.Tests 127, Quarry.Migration.Tests 201, Quarry.Tests 3025).
