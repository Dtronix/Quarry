...
| 4 | 2026-04-23 REMEDIATE | | Six-phase remediation complete (Phases 1-6): walker fail-loud on SqlRawExpr + string-column concat guard, captured-var metadata propagation, B-item polish, QRY029 for projection-path validation, expanded test coverage, operator-table dedup with SqlExprRenderer. Rebased on origin/master (picked up #261). All 3265 tests green; CI green on run 24856342842. PR body updated. Ready for user confirmation to finalize. |
