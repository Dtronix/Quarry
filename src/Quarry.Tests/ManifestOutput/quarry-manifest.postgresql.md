...
```sql
INSERT INTO "accounts" ("UserId", "AccountName", "Balance", "credit_limit", "IsActive") VALUES ($1, $2, $3, $4, $5)
```
...
```sql
UPDATE "order_items" SET "LineTotal" = $1 WHERE "OrderItemId" = 1
```
...
```sql
SELECT "Total", LAG("Total", $2, $3) OVER (ORDER BY "OrderId") AS "Prev" FROM "orders" WHERE "Total" > $1 ORDER BY "OrderId" ASC LIMIT $4
```
...
```sql
INSERT INTO "products" ("ProductName", "Price", "Description") VALUES ($1, $2, $3)
```
...
```sql
SELECT "ProductId", "ProductName", "Price", "Description", "DiscountedPrice" FROM "products" WHERE "ProductName" = $1
```
...
```sql
SELECT "d"."UserName" FROM (SELECT DISTINCT "t0"."UserName" AS "UserName", "t1"."Total" AS "_o0" FROM "users" AS "t0" INNER JOIN "orders" AS "t1" ON "t0"."UserId" = "t1"."UserId" WHERE "t1"."Total" > 0) AS "d" ORDER BY "d"."_o0" ASC LIMIT 20
```
...
```sql
SELECT "d"."UserName" FROM (SELECT DISTINCT "t0"."UserName" AS "UserName", ("t1"."Total" + $2) AS "_o0" FROM "users" AS "t0" INNER JOIN "orders" AS "t1" ON "t0"."UserId" = "t1"."UserId" WHERE "t1"."Total" > $1) AS "d" ORDER BY "d"."_o0" ASC
```
...
```sql
SELECT "UserId", "UserName" FROM "users" ORDER BY "UserId" ASC LIMIT $1 OFFSET $2
```
...
```sql
SELECT "UserId", "UserName" FROM "users" ORDER BY "UserId" ASC LIMIT $1 OFFSET 1
```
...
```sql
SELECT "UserId", "UserName", "Email", "IsActive", "CreatedAt", "LastLogin" FROM "users" ORDER BY "UserId" ASC OFFSET 1
```
...
-- +limitOn
SELECT "UserId", "UserName", "Email", "IsActive", "CreatedAt", "LastLogin" FROM "users" WHERE "UserId" >= $1 ORDER BY "UserId" ASC LIMIT $2
```
...
```sql
SELECT "UserId", coalesce("CreatedAt", $1) AS "Stamp" FROM "users"
```
...
```sql
SELECT "UserId", "UserName" FROM "users" UNION SELECT "UserId", "UserName" FROM "users" WHERE "IsActive" = TRUE EXCEPT SELECT "UserId", "UserName" FROM "users" WHERE "UserId" = 1
```
...
```sql
-- +strict
SELECT "UserId", "UserName", "Email", "IsActive", "CreatedAt", "LastLogin" FROM "users" WHERE ("UserId" >= 2) AND ("IsActive" = TRUE)
...
```sql
UPDATE "users" SET "UserName" = $1, "Email" = $2 WHERE "UserId" = 1
```
...
```sql
UPDATE "users" SET "UserName" = $1, "IsActive" = $2 WHERE "UserId" = 2
```
...
```sql
UPDATE "users" SET "UserName" = $1, "IsActive" = FALSE WHERE "UserId" = 2
```
...
```sql
SELECT DISTINCT "UserId", "UserName", "Email", "IsActive", "CreatedAt", "LastLogin" FROM "users" WHERE "IsActive" = TRUE ORDER BY "UserName" ASC
```
...
```sql
SELECT "d"."UserName", "d"."OrderCount" FROM (SELECT DISTINCT "UserName" AS "UserName", (SELECT COUNT(*) FROM "orders" AS "sq0" WHERE "sq0"."UserId" = "users"."UserId") AS "OrderCount", "Email" AS "_o0" FROM "users" WHERE "IsActive" = TRUE) AS "d" ORDER BY "d"."_o0" ASC
```
...
```sql
SELECT "UserId", "UserName", "Email", "IsActive", "CreatedAt", "LastLogin" FROM "users" WHERE "IsActive" = TRUE ORDER BY "UserId" ASC
```
...
```sql
SELECT DISTINCT "UserName", "Email" FROM "users" WHERE "IsActive" = TRUE ORDER BY "UserName" ASC, "Email" ASC
```
...
```sql
SELECT "UserName" FROM "users" WHERE "UserId" IN ({__COL_P0__}) AND "UserId" > $2 ORDER BY "UserId" ASC LIMIT $3
```
...
```sql
SELECT "UserName", (SELECT SUM("sq0"."Total") FROM "orders" AS "sq0" WHERE "sq0"."UserId" = "users"."UserId") AS "OrderTotal", (SELECT COUNT(*) FROM "orders" AS "sq0" WHERE "sq0"."UserId" = "users"."UserId") AS "OrderCount" FROM "users" WHERE "IsActive" = TRUE ORDER BY "UserId" ASC
```
...
```sql
SELECT "UserId", "UserName" FROM "users" WHERE "IsActive" = TRUE AND EXISTS (SELECT 1 FROM "orders" AS "sq0" WHERE "sq0"."UserId" = "users"."UserId")
```
...
```sql
SELECT "UserId", "UserName" FROM "users" WHERE (SELECT COUNT(*) FROM "orders" AS "sq0" WHERE "sq0"."UserId" = "users"."UserId" AND ("sq0"."Total" > $1)) > 0
```
...
```sql
SELECT "UserId", "UserName" FROM "users" WHERE (SELECT MAX("sq0"."OrderDate") FROM "orders" AS "sq0" WHERE "sq0"."UserId" = "users"."UserId") > $1
```
...
```sql
SELECT "UserId", "UserName" FROM "users" WHERE EXISTS (SELECT 1 FROM "orders" AS "sq0" WHERE "sq0"."UserId" = "users"."UserId" AND ("sq0"."Notes" IS NOT NULL AND ("sq0"."Total" > $1)))
```
...
```sql
SELECT "UserId", "UserName" FROM "users" WHERE EXISTS (SELECT 1 FROM "orders" AS "sq0" WHERE "sq0"."UserId" = "users"."UserId" AND ("sq0"."Status" LIKE '%' || $1 || '%'))
```
...
```sql
SELECT "UserId", "UserName" FROM "users" WHERE EXISTS (SELECT 1 FROM "orders" AS "sq0" WHERE "sq0"."UserId" = "users"."UserId" AND ("sq0"."Total" > $1))
```
...
```sql
SELECT "UserId", "UserName" FROM "users" WHERE EXISTS (SELECT 1 FROM "orders" AS "sq0" WHERE "sq0"."UserId" = "users"."UserId") OR "IsActive" = TRUE
```
...
```sql
SELECT "UserId", "UserName" FROM "users" WHERE NOT EXISTS (SELECT 1 FROM "orders" AS "sq0" WHERE "sq0"."UserId" = "users"."UserId" AND NOT ("sq0"."Status" = $1))
```
...
```sql
SELECT "UserId", "UserName" FROM "users" WHERE EXISTS (SELECT 1 FROM "orders" AS "sq0" WHERE "sq0"."UserId" = "users"."UserId" AND (EXISTS (SELECT 1 FROM "order_items" AS "sq1" WHERE "sq1"."OrderId" = "sq0"."OrderId" AND (EXISTS (SELECT 1 FROM "tags" AS "sq2" WHERE "sq2"."OrderItemId" = "sq1"."OrderItemId" AND ("sq2"."TagValue" = $1))))))
```
...
-- +true
SELECT "UserId", "UserName", "Email", "IsActive", "CreatedAt", "LastLogin" FROM "users" WHERE "IsActive" = TRUE ORDER BY "UserName" ASC LIMIT 10
```
