...
internal static class PostgresTestContainer
{
    ...
    ///   <item><description><c>REAL</c> (single-precision in PG) is replaced with <c>DOUBLE PRECISION</c> to preserve the precision SQLite's <c>REAL</c> gives for money columns.</description></item>
