...
internal class CrossDialectInsertTests : CrossDialectTestBase
{
    ...
    {
        AssertDialects(
            Lite.Users().Insert(new User { UserName = "x", IsActive = true, CreatedAt = default }).ToSql(),
            Pg.Users().Insert(new Pg.User { UserName = "x", IsActive = true, CreatedAt = default }).ToSql(),
            My.Users().Insert(new My.User { UserName = "x", IsActive = true, CreatedAt = default }).ToSql(),
            Ss.Users().Insert(new Ss.User { UserName = "x", IsActive = true, CreatedAt = default }).ToSql(),
    ...
    {
        AssertDialects(
            Lite.Users().Insert(new User { UserName = "x" }).Values(new User { UserName = "y" }).ToSql(),
            Pg.Users().Insert(new Pg.User { UserName = "x" }).Values(new Pg.User { UserName = "y" }).ToSql(),
            My.Users().Insert(new My.User { UserName = "x" }).Values(new My.User { UserName = "y" }).ToSql(),
            Ss.Users().Insert(new Ss.User { UserName = "x" }).Values(new Ss.User { UserName = "y" }).ToSql(),
    ...
    {
        AssertDialects(
            Lite.Users().InsertMany(new[] { new User { UserName = "a" }, new User { UserName = "b" }, new User { UserName = "c" } }).ToSql(),
            Pg.Users().InsertMany(new[] { new Pg.User { UserName = "a" }, new Pg.User { UserName = "b" }, new Pg.User { UserName = "c" } }).ToSql(),
            My.Users().InsertMany(new[] { new My.User { UserName = "a" }, new My.User { UserName = "b" }, new My.User { UserName = "c" } }).ToSql(),
            Ss.Users().InsertMany(new[] { new Ss.User { UserName = "a" }, new Ss.User { UserName = "b" }, new Ss.User { UserName = "c" } }).ToSql(),
    ...
    {
        AssertDialects(
            Lite.Orders().Insert(new Order { UserId = 1, Total = 0m, Status = "x", OrderDate = default }).ToSql(),
            Pg.Orders().Insert(new Pg.Order { UserId = 1, Total = 0m, Status = "x", OrderDate = default }).ToSql(),
            My.Orders().Insert(new My.Order { UserId = 1, Total = 0m, Status = "x", OrderDate = default }).ToSql(),
            Ss.Orders().Insert(new Ss.Order { UserId = 1, Total = 0m, Status = "x", OrderDate = default }).ToSql(),
    ...
    {
        AssertDialects(
            Lite.Orders().Insert(new Order { UserId = 1, Status = "x" }).Values(new Order { UserId = 2, Status = "y" }).ToSql(),
            Pg.Orders().Insert(new Pg.Order { UserId = 1, Status = "x" }).Values(new Pg.Order { UserId = 2, Status = "y" }).ToSql(),
            My.Orders().Insert(new My.Order { UserId = 1, Status = "x" }).Values(new My.Order { UserId = 2, Status = "y" }).ToSql(),
            Ss.Orders().Insert(new Ss.Order { UserId = 1, Status = "x" }).Values(new Ss.Order { UserId = 2, Status = "y" }).ToSql(),
    ...
    {
        AssertDialects(
            Lite.OrderItems().Insert(new OrderItem { OrderId = 1, ProductName = "x", Quantity = 0, UnitPrice = 0m, LineTotal = 0m }).ToSql(),
            Pg.OrderItems().Insert(new Pg.OrderItem { OrderId = 1, ProductName = "x", Quantity = 0, UnitPrice = 0m, LineTotal = 0m }).ToSql(),
            My.OrderItems().Insert(new My.OrderItem { OrderId = 1, ProductName = "x", Quantity = 0, UnitPrice = 0m, LineTotal = 0m }).ToSql(),
            Ss.OrderItems().Insert(new Ss.OrderItem { OrderId = 1, ProductName = "x", Quantity = 0, UnitPrice = 0m, LineTotal = 0m }).ToSql(),
