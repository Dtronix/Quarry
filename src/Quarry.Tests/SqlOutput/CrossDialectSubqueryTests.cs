...
internal class CrossDialectSubqueryTests : CrossDialectTestBase
{
    ...
    {
        AssertDialects(
            Lite.Users.Where(u => u.Orders.Any()).ToTestCase(),
            Pg.Users.Where(u => u.Orders.Any()).ToTestCase(),
            My.Users.Where(u => u.Orders.Any()).ToTestCase(),
            Ss.Users.Where(u => u.Orders.Any()).ToTestCase(),
    ...
    {
        AssertDialects(
            Lite.Users.Where(u => u.Orders.Any(o => o.Total > 100)).ToTestCase(),
            Pg.Users.Where(u => u.Orders.Any(o => o.Total > 100)).ToTestCase(),
            My.Users.Where(u => u.Orders.Any(o => o.Total > 100)).ToTestCase(),
            Ss.Users.Where(u => u.Orders.Any(o => o.Total > 100)).ToTestCase(),
    ...
    {
        AssertDialects(
            Lite.Users.Where(u => u.Orders.Any(o => o.Status == "paid")).ToTestCase(),
            Pg.Users.Where(u => u.Orders.Any(o => o.Status == "paid")).ToTestCase(),
            My.Users.Where(u => u.Orders.Any(o => o.Status == "paid")).ToTestCase(),
            Ss.Users.Where(u => u.Orders.Any(o => o.Status == "paid")).ToTestCase(),
    ...
    {
        AssertDialects(
            Lite.Users.Where(u => u.Orders.All(o => o.Status == "paid")).ToTestCase(),
            Pg.Users.Where(u => u.Orders.All(o => o.Status == "paid")).ToTestCase(),
            My.Users.Where(u => u.Orders.All(o => o.Status == "paid")).ToTestCase(),
            Ss.Users.Where(u => u.Orders.All(o => o.Status == "paid")).ToTestCase(),
    ...
    {
        AssertDialects(
            Lite.Users.Where(u => u.Orders.Count() > 5).ToTestCase(),
            Pg.Users.Where(u => u.Orders.Count() > 5).ToTestCase(),
            My.Users.Where(u => u.Orders.Count() > 5).ToTestCase(),
            Ss.Users.Where(u => u.Orders.Count() > 5).ToTestCase(),
    ...
    {
        AssertDialects(
            Lite.Users.Where(u => u.Orders.Count() == 0).ToTestCase(),
            Pg.Users.Where(u => u.Orders.Count() == 0).ToTestCase(),
            My.Users.Where(u => u.Orders.Count() == 0).ToTestCase(),
            Ss.Users.Where(u => u.Orders.Count() == 0).ToTestCase(),
    ...
    {
        AssertDialects(
            Lite.Users.Where(u => u.Orders.Count(o => o.Total > 100) > 2).ToTestCase(),
            Pg.Users.Where(u => u.Orders.Count(o => o.Total > 100) > 2).ToTestCase(),
            My.Users.Where(u => u.Orders.Count(o => o.Total > 100) > 2).ToTestCase(),
            Ss.Users.Where(u => u.Orders.Count(o => o.Total > 100) > 2).ToTestCase(),
    ...
    {
        AssertDialects(
            Lite.Users.Where(u => u.Orders.Count(o => o.Status == "paid") >= 1).ToTestCase(),
            Pg.Users.Where(u => u.Orders.Count(o => o.Status == "paid") >= 1).ToTestCase(),
            My.Users.Where(u => u.Orders.Count(o => o.Status == "paid") >= 1).ToTestCase(),
            Ss.Users.Where(u => u.Orders.Count(o => o.Status == "paid") >= 1).ToTestCase(),
    ...
    public void Where_Count_WithCapturedVariable()
    {
        var minTotal = 50m;
        AssertDialects(
            Lite.Users.Where(u => u.Orders.Count(o => o.Total > minTotal) > 0).ToTestCase(),
            Pg.Users.Where(u => u.Orders.Count(o => o.Total > minTotal) > 0).ToTestCase(),
            My.Users.Where(u => u.Orders.Count(o => o.Total > minTotal) > 0).ToTestCase(),
            Ss.Users.Where(u => u.Orders.Count(o => o.Total > minTotal) > 0).ToTestCase(),
    ...
    {
        AssertDialects(
            Lite.Users.Where(u => u.Orders.Any(o => o.Items.Any(i => i.UnitPrice > 50))).ToTestCase(),
            Pg.Users.Where(u => u.Orders.Any(o => o.Items.Any(i => i.UnitPrice > 50))).ToTestCase(),
            My.Users.Where(u => u.Orders.Any(o => o.Items.Any(i => i.UnitPrice > 50))).ToTestCase(),
            Ss.Users.Where(u => u.Orders.Any(o => o.Items.Any(i => i.UnitPrice > 50))).ToTestCase(),
    ...
    {
        AssertDialects(
            Lite.Users.Where(u => u.Orders.Any(o => o.Items.All(i => i.Quantity > 0))).ToTestCase(),
            Pg.Users.Where(u => u.Orders.Any(o => o.Items.All(i => i.Quantity > 0))).ToTestCase(),
            My.Users.Where(u => u.Orders.Any(o => o.Items.All(i => i.Quantity > 0))).ToTestCase(),
            Ss.Users.Where(u => u.Orders.Any(o => o.Items.All(i => i.Quantity > 0))).ToTestCase(),
    ...
    public void Where_Any_WithCapturedVariable()
    {
        var minAmount = 100m;
        AssertDialects(
            Lite.Users.Where(u => u.Orders.Any(o => o.Total > minAmount)).ToTestCase(),
            Pg.Users.Where(u => u.Orders.Any(o => o.Total > minAmount)).ToTestCase(),
            My.Users.Where(u => u.Orders.Any(o => o.Total > minAmount)).ToTestCase(),
            Ss.Users.Where(u => u.Orders.Any(o => o.Total > minAmount)).ToTestCase(),
    ...
    public void Where_All_WithCapturedVariable()
    {
        var status = "paid";
        AssertDialects(
            Lite.Users.Where(u => u.Orders.All(o => o.Status == status)).ToTestCase(),
            Pg.Users.Where(u => u.Orders.All(o => o.Status == status)).ToTestCase(),
            My.Users.Where(u => u.Orders.All(o => o.Status == status)).ToTestCase(),
            Ss.Users.Where(u => u.Orders.All(o => o.Status == status)).ToTestCase(),
    ...
    {
        AssertDialects(
            Lite.Users.Where(u => u.IsActive && u.Orders.Any()).ToTestCase(),
            Pg.Users.Where(u => u.IsActive && u.Orders.Any()).ToTestCase(),
            My.Users.Where(u => u.IsActive && u.Orders.Any()).ToTestCase(),
            Ss.Users.Where(u => u.IsActive && u.Orders.Any()).ToTestCase(),
    ...
    {
        AssertDialects(
            Lite.Users.Where(u => u.Orders.Any()).Select(u => (u.UserId, u.UserName)).ToTestCase(),
            Pg.Users.Where(u => u.Orders.Any()).Select(u => (u.UserId, u.UserName)).ToTestCase(),
            My.Users.Where(u => u.Orders.Any()).Select(u => (u.UserId, u.UserName)).ToTestCase(),
            Ss.Users.Where(u => u.Orders.Any()).Select(u => (u.UserId, u.UserName)).ToTestCase(),
    ...
    {
        AssertDialects(
            Lite.Users.Where(u => u.Orders.Any() || u.IsActive).ToTestCase(),
            Pg.Users.Where(u => u.Orders.Any() || u.IsActive).ToTestCase(),
            My.Users.Where(u => u.Orders.Any() || u.IsActive).ToTestCase(),
            Ss.Users.Where(u => u.Orders.Any() || u.IsActive).ToTestCase(),
    ...
    {
        AssertDialects(
            Lite.Users.Where(u => u.Orders.Any() && u.Orders.Any(o => o.Total > 100)).ToTestCase(),
            Pg.Users.Where(u => u.Orders.Any() && u.Orders.Any(o => o.Total > 100)).ToTestCase(),
            My.Users.Where(u => u.Orders.Any() && u.Orders.Any(o => o.Total > 100)).ToTestCase(),
            Ss.Users.Where(u => u.Orders.Any() && u.Orders.Any(o => o.Total > 100)).ToTestCase(),
    ...
    {
        AssertDialects(
            Lite.Users.Where(u => u.Orders.Any(o => o.Items.Any())).ToTestCase(),
            Pg.Users.Where(u => u.Orders.Any(o => o.Items.Any())).ToTestCase(),
            My.Users.Where(u => u.Orders.Any(o => o.Items.Any())).ToTestCase(),
            Ss.Users.Where(u => u.Orders.Any(o => o.Items.Any())).ToTestCase(),
    ...
    {
        AssertDialects(
            Lite.Users.Where(u => u.Orders.Any(o => o.Status.Contains("paid"))).ToTestCase(),
            Pg.Users.Where(u => u.Orders.Any(o => o.Status.Contains("paid"))).ToTestCase(),
            My.Users.Where(u => u.Orders.Any(o => o.Status.Contains("paid"))).ToTestCase(),
            Ss.Users.Where(u => u.Orders.Any(o => o.Status.Contains("paid"))).ToTestCase(),
    ...
    {
        AssertDialects(
            Lite.Users.Where(u => u.Orders.Any(o => o.Status.StartsWith("p"))).ToTestCase(),
            Pg.Users.Where(u => u.Orders.Any(o => o.Status.StartsWith("p"))).ToTestCase(),
            My.Users.Where(u => u.Orders.Any(o => o.Status.StartsWith("p"))).ToTestCase(),
            Ss.Users.Where(u => u.Orders.Any(o => o.Status.StartsWith("p"))).ToTestCase(),
            sqlite: "SELECT * FROM \"users\" WHERE EXISTS (SELECT 1 FROM \"orders\" AS \"sq0\" WHERE \"sq0\".\"UserId\" = \"users\".\"UserId\" AND (\"sq0\".\"Status\" LIKE @p0 || '%'))",
            pg:     "SELECT * FROM \"users\" WHERE EXISTS (SELECT 1 FROM \"orders\" AS \"sq0\" WHERE \"sq0\".\"UserId\" = \"users\".\"UserId\" AND (\"sq0\".\"Status\" LIKE @p0 || '%'))",
            mysql:  "SELECT * FROM `users` WHERE EXISTS (SELECT 1 FROM `orders` AS `sq0` WHERE `sq0`.`UserId` = `users`.`UserId` AND (`sq0`.`Status` LIKE CONCAT(@p0, '%')))",
            ss:     "SELECT * FROM [users] WHERE EXISTS (SELECT 1 FROM [orders] AS [sq0] WHERE [sq0].[UserId] = [users].[UserId] AND ([sq0].[Status] LIKE @p0 + '%'))");
