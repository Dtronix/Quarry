...
internal static partial class InterceptorCodeGenerator
{
        ...
        IReadOnlyList<PrebuiltChainInfo>? prebuiltChains = null)
    {
        ...
        // Note: CS9144 (cross-context interceptor type mismatch) was suppressed here historically.
        // The fix in GroupByFileAndProcess — grouping by (ContextClassName, FilePath) — ensures
        // Insert interceptors are scoped to the correct context, so the suppression is no longer needed.
        sb.AppendLine();
