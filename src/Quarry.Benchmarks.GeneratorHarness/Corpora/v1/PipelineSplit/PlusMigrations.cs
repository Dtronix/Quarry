...
// PipelineSplit + queries + migrations: PlusQueries content + 10 minimal
// migrations and 1 snapshot. Migration bodies are intentionally trivial —
// the goal is to fire Pipeline 3 (migration discovery + MigrateAsync emit)
// across a representative count, not to model real upgrade work.
using Quarry;
...
[MigrationSnapshot(Version = 1, Name = "Init", Timestamp = "2026-01-01T00:00:00.0000000+00:00", SchemaHash = "0000000000000001")]
internal static partial class M001Snapshot { }

[Migration(Version = 1, Name = "Init")]
internal static partial class M001 { public static void Upgrade(MigrationBuilder b) { } public static void Downgrade(MigrationBuilder b) { } public static void Backup(MigrationBuilder b) { } }

[Migration(Version = 2, Name = "AddCol2")]
internal static partial class M002 { public static void Upgrade(MigrationBuilder b) { } public static void Downgrade(MigrationBuilder b) { } public static void Backup(MigrationBuilder b) { } }

[Migration(Version = 3, Name = "AddCol3")]
internal static partial class M003 { public static void Upgrade(MigrationBuilder b) { } public static void Downgrade(MigrationBuilder b) { } public static void Backup(MigrationBuilder b) { } }

[Migration(Version = 4, Name = "AddCol4")]
internal static partial class M004 { public static void Upgrade(MigrationBuilder b) { } public static void Downgrade(MigrationBuilder b) { } public static void Backup(MigrationBuilder b) { } }

[Migration(Version = 5, Name = "AddCol5")]
internal static partial class M005 { public static void Upgrade(MigrationBuilder b) { } public static void Downgrade(MigrationBuilder b) { } public static void Backup(MigrationBuilder b) { } }

[Migration(Version = 6, Name = "AddCol6")]
internal static partial class M006 { public static void Upgrade(MigrationBuilder b) { } public static void Downgrade(MigrationBuilder b) { } public static void Backup(MigrationBuilder b) { } }

[Migration(Version = 7, Name = "AddCol7")]
internal static partial class M007 { public static void Upgrade(MigrationBuilder b) { } public static void Downgrade(MigrationBuilder b) { } public static void Backup(MigrationBuilder b) { } }

[Migration(Version = 8, Name = "AddCol8")]
internal static partial class M008 { public static void Upgrade(MigrationBuilder b) { } public static void Downgrade(MigrationBuilder b) { } public static void Backup(MigrationBuilder b) { } }

[Migration(Version = 9, Name = "AddCol9")]
internal static partial class M009 { public static void Upgrade(MigrationBuilder b) { } public static void Downgrade(MigrationBuilder b) { } public static void Backup(MigrationBuilder b) { } }

[Migration(Version = 10, Name = "AddCol10")]
internal static partial class M010 { public static void Upgrade(MigrationBuilder b) { } public static void Downgrade(MigrationBuilder b) { } public static void Backup(MigrationBuilder b) { } }
